...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-40 right-20 w-32 h-32 bg-blue-200 rounded-full opacity-20 animate-float" style={{animationDelay: '2s'}}></div>
      <div className="absolute bottom-40 left-20 w-16 h-16 bg-indigo-200 rounded-full opacity-20 animate-float" style={{animationDelay: '4s'}}></div>
        ...
        <div className="animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="text-lg px-8 py-4 h-auto hover:bg-gray-50"
            >
